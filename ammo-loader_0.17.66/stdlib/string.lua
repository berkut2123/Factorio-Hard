...
---Dump multiple objects into a human-readable string. Will convert all non-string arguments to strings.
---@return string
function string.concat(...)
    local fin = ""
    for i = 1, select("#", ...) do
        fin = fin .. string.toString(select(i, ...))
    end
    return fin
end

---Dump variable to readable string. Recursively converts tables as well.
---@param o any
---@return string
