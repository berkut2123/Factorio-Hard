...
if settings.startup["bobmods-revamp-old-oil"].value == true or settings.startup["bobmods-revamp-oil"].value == true then
  ...
  bobmods.lib.tech.remove_recipe_unlock("oil-processing", "solid-fuel-from-light-oil") -- pre 0.17.60
  bobmods.lib.tech.remove_recipe_unlock("oil-processing", "solid-fuel-from-heavy-oil") -- pre 0.17.60
  bobmods.lib.tech.remove_recipe_unlock("advanced-oil-processing", "solid-fuel-from-light-oil") -- post 0.17.60
  bobmods.lib.tech.remove_recipe_unlock("advanced-oil-processing", "solid-fuel-from-heavy-oil") -- post 0.17.60
  ...
  bobmods.lib.recipe.set_result("coal-liquefaction", {"heavy-oil", 10})
