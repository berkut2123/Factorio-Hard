...
--[[
generate unit selection circles for various sizes, circle is 10 tile across at scale 1
1 = 0.25r, 2 = 0.5r, 3 = 0.75r, 4 = 1r, etc...

for i = 1, 20, 1 do
  local base = data.raw["simple-entity"]["unit-selection"]
  local new = table.deepcopy(base)
  new.name = new.name .. "-" .. i
  new.pictures[1].scale = (i / 20) + 0.25
  data:extend({new})
end
]]--
