...
local use_train = "all trains"
local use_snapping = true
...
remote.add_interface("loader-pro",	{
...
function init_supported_loaders()
	...
	remote.call("loader-pro", "add_loader", "loader-pro-001")
	remote.call("loader-pro", "add_loader", "loader-pro-002")
	remote.call("loader-pro", "add_loader", "loader-pro-01")
	remote.call("loader-pro", "add_loader", "loader-pro-02")
	remote.call("loader-pro", "add_loader", "loader-pro-03")
end
...
script.on_configuration_changed(unlockRecipe)