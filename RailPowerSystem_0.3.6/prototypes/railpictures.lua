rail_pictures_internal = function(elems)
  ...
  for _ , key in ipairs(keys) do
    ...
    for _ , elem in ipairs(elems) do
      part[elem[1]] = { sheet = {
        filename = string.format("__"..ModName.."__/graphics/entity/%s/%s-%s-%s.png", dashkey, dashkey, key[2], elem[2]),
        priority = "extra-high",
        ...
        hr_version = {
          filename = string.format("__"..ModName.."__/graphics/entity/%s/hr-%s-%s-%s.png", dashkey, dashkey, key[2], elem[2]),
          priority = "extra-high",
          flags = elem.mipmap and { "icon" },
          width = key[3]*2,
          height = key[4]*2,
